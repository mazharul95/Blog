    ...
    <div class="container box_1620">
        <div class="banner_inner d-flex align-items-center">
            <div class="banner_content">
                <div class="media">
                    <div class="d-flex">
                        <img src="{{asset('frontend')}}/img/personal.jpg" alt="">
                    </div>
    ...
    <div class="container">
        <div class="gallery_f_inner row imageGallery1">
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 brand creative print">
                <div class="h_gallery_item">
                    <div class="g_img_item">
                        <img class="img-fluid" src="{{asset('frontend')}}/img/gallery/project-4.jpg" alt="">
                        <a class="light" href="{{asset('frontend')}}/img/gallery/project-4.jpg"><img src="img/gallery/icon.png" alt=""></a>
                    </div>
                    <div class="g_item_text">
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 brand manipul design">
                <div class="h_gallery_item">
                    <div class="g_img_item">
                        <img class="img-fluid" src="{{asset('frontend')}}/img/gallery/project-5.jpg" alt="">
                        <a class="light" href="{{asset('frontend')}}/img/gallery/project-5.jpg"><img src="img/gallery/icon.png" alt=""></a>
                    </div>
                    <div class="g_item_text">
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 brand creative">
                <div class="h_gallery_item">
                    <div class="g_img_item">
                        <img class="img-fluid" src="{{asset('frontend')}}/img/gallery/project-6.jpg" alt="">
                        <a class="light" href="{{asset('frontend')}}/img/gallery/project-6.jpg"><img src="img/gallery/icon.png" alt=""></a>
                    </div>
                    <div class="g_item_text">
